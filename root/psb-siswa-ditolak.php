...
$perintah="SELECT*FROM tpdb_daftar where status_siswa='Ditolak'";
$nom="$awal";
...
<div class="row">
                <div class="col-lg-12">
                <h2 class="page-header">Siswa yang ditolak</h2>
...
<a href="print-101-Zb-index/<?php echo $data['id']?>" target=_"blank"><i class="fa fa-print fa-fw" alt="print" title="Print"></i></a>
</td>
