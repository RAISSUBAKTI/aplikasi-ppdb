                ...
                <h2 class="page-header">Data Semua siswa</h2>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Semua siswa yang sudah mendaftar Di MTs. Ulul Albab
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr>
                                        ...
                                        <th><?php echo $jumlah_siswa; ?></th>
                                         <th><a href="print-101-Za-index/" target=_"blank"><i class="fa fa-print fa-fw" alt="print" title="Print"></i></a></th>                                      
